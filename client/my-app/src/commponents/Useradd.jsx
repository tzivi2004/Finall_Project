...
export const Useradd = ({ visible, setUserUpdateState, setUser, getYorUser, users, SetMyUpdatUser, MyUpdatUser, getUser }) => {
    ...
    const isUnique = async (username) => {
        const response = users.filter(e => e.username == username);
        if (response) {
            setUn(true)
            return true
        }
    ...
    return (
        <div className="form-demo">
            ...
            <div className="flex justify-content-center">
                <Dialog visible={true} onHide={() => { setUserUpdateState(false) }}>
                    <div className="card">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="p-fluid">
                            ...
                            {MyUpdatUser.password ? <></> : <div className="field">
                                <span className="p-float-label">
